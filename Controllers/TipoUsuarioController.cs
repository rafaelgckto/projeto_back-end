...
namespace ToBuy.Controllers {
    ...
    public class TipoUsuarioController : ControllerBase {
        ...
        public async Task<ActionResult<List<TipoUsuario>>> Get () {
            try {
                List<TipoUsuario> lstTipoUsuario = await _tipousuarioRepository.Listar ();
        ...
        public async Task<ActionResult<TipoUsuario>> Get (int id) {
            try {
                TipoUsuario tipoUsuario = await _tipousuarioRepository.BuscarPorId (id);
        ...
        public async Task<ActionResult<TipoUsuario>> Post (TipoUsuario tipo_usuario) {
            try {
                return await _tipousuarioRepository.Cadastrar (tipo_usuario);
            } catch (Exception ex) {
                throw ex;
            }
        }
        ...
        public async Task<ActionResult<TipoUsuario>> Put (int id, TipoUsuario tipo_usuario) {
            ...
            try {
                return await _tipousuarioRepository.Atualizar (tipo_usuario);
            } catch (DbUpdateException ex) {
                var tipo_usuarioValido = await _tipousuarioRepository.BuscarPorId (id);
        ...
        public async Task<ActionResult<TipoUsuario>> Delete (int id) {
            try {
                TipoUsuario tipo_usuarioRetornado = await _tipousuarioRepository.BuscarPorId (id);

                if (tipo_usuarioRetornado == null) {
                    return NotFound ();
                }

                await _tipousuarioRepository.Deletar (tipo_usuarioRetornado);
